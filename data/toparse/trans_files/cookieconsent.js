...
(function(){
    ...
    var CookieConsent = function(root){
        ...
        var _createConsentModal = function(lang){            
            ...
            var loi25link = _createNode('a');
            loi25link.href = "https://www.loi25solution.com";
            loi25link.target = "_blank";

            var loi25Div = _createNode('div');
            loi25Div.className = "loi25";

            var poweredBy = _createNode('span');
            poweredBy.innerHTML = (_config.current_lang == 'fr' ? 'Propulsé par ' : 'Powered by ');

            var logo = _createNode('img');
            logo.src = "https://www.loi25solution.com/images/logo_politique.png";
            logo.className = "loi25logo";

            loi25Div.appendChild(poweredBy);
            loi25Div.appendChild(logo);
            loi25link.appendChild(loi25Div)

            consent_modal_inner.appendChild(loi25link);
