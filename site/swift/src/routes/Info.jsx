const Info = () => {
    return (
        <div>
            ...
            <p>Ici, un bouton menant au formulaire sous forme de Forms ou autre logiciel où les réponses sont accessibles au propriétaire du domaine.</p>
        </div>
    )
}
